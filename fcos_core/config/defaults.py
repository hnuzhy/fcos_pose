...
_C.MODEL.POSENET_ON = False  # add the stacked hourglasses network as an auxiliary
...
# ---------------------------------------------------------------------------- #
_C.MODEL.POSENET = CN()
_C.MODEL.POSENET.N_STACK = 4
# number of keypoints / heatmaps. COCO is 17, MPII is 16
_C.MODEL.POSENET.OUTPUT_DIM = 17  
# SIGMA range for heatmap generation in modeling/pose/heatmap.py file
_C.MODEL.POSENET.SIGMA = 2  
# how to fuse pose features is modeling/pose/posenet.py file, options: ["LAST", "FULL"]
_C.MODEL.POSENET.FUSE_TYPE = "LAST" 
