...
def compute_thresholds_for_classes(coco_eval):
    ...
    # here, precision.shape is (100, len(classes))
    recall = np.linspace(0, 1, num=precision.shape[0])
    recall = recall[:, None]  # here, recall.shape from (100,) to (100, 1)
    ...
    # print("[self-added] precision: \t", precision)
    # print("[self-added] recall: \t", recall)
