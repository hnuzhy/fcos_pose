...
def build_resnet_fpn_backbone(cfg):
    ...
    model.c5_channels = in_channels_stage2 * 8  # new added for POSENET
    return model
...
def build_resnet_fpn_p3p7_backbone(cfg):
    ...
    fpn = fpn_module.FPN(
        ...
        output_c5_feature=cfg.MODEL.POSENET_ON,  # new added for POSENET
    )
    model = nn.Sequential(OrderedDict([("body", body), ("fpn", fpn)]))
    model.out_channels = out_channels
    model.c5_channels = in_channels_stage2 * 2  # new added for POSENET, actually is c3_channels
    # model.c5_channels = in_channels_stage2 * 8  # new added for POSENET, actually is c5_channels
    return model
